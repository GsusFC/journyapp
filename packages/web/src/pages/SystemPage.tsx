        ...
        <PageLayout title="System Control" subtitle="V1.0.0 :: BASE SEPOLIA">
            <div className="grid grid-cols-1 gap-4">
                ...
                <motion.div
                    ...
                    className="bg-surface dark:bg-zinc-900 border border-stroke p-6 flex flex-col justify-between h-auto min-h-[160px]"
                >
                ...
                <motion.div
                    ...
                    className="bg-surface dark:bg-zinc-900 border border-stroke p-6"
                >
                    <div className="font-mono text-[10px] text-text-primary/40 uppercase tracking-widest mb-4">
                                // MODULE: INTERFACE
                    </div>
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                theme === 'light'
                                    ...
                                    : "border-stroke text-text-primary/40 hover:border-text-primary/40 hover:text-text-primary"
                            )}
                        >
